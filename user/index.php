...
if(isset($_POST['book'])){
	...
	$tplace = $_POST['dep_city'];
	$fplace = $_POST['arr_city'];
	...
	$str = "select count(*) as cnt from flight_data where place_from='".$tplace."' and place_to ='".$fplace."' ";
	...
	if ($cnt > 0){
		 ...
		 $que = "select flight_id , start_time , end_time , prize from flight_data where place_from='".$tplace."' and place_to ='".$fplace."' ";
		 $swa = mysqli_query($conn , $que);
		 $data = mysqli_fetch_array($swa);
		 $name = $_SESSION['user_name'];
		$flight_id= $data['flight_id'];
		$start_time= $data['start_time'];	
		$end_time = $data['end_time'];
		$prize = $data['prize'] * $pass_count;
		// echo $start_time;
		// echo $end_time;
		if($swa){
			$str = "insert into book_flight (user_id , flight_id ,user_name, place_from , place_to , start_date , end_date,
			start_time , end_time , seat ,class , prize) values('$user_id','$flight_id','$name','$tplace' ,'$fplace' , '$start_date' , '$end_date',
			'$start_time' , '$end_time' ,'$pass_count' , '$class' ,'$prize')";
		$res = mysqli_query($conn , $str);	

		$msg= "filght is booked";
...
<body>
		...
		<h1 class="text-light brand mt-2">
			<img src="../images/airtic.png" height="105px" width="105px" alt="">				
		Online Flight Booking</h1>
		<div class="sap_tabs">			
			<div id="horizontalTab" style="display: block; width: 100%; margin: 0px;">
				<ul class="resp-tabs-list">
					<li class="resp-tab-item resp-tab-active" aria-controls="tab_item-0" role="tab"><span>Round Trip</span></li>
					<!-- <li class="resp-tab-item" aria-controls="tab_item-1" role="tab"><span>One way</span></li> -->
				</ul>	
				<div class="clearfix"> </div>	
				<div class="resp-tabs-container">
					<h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-0"><span class="resp-arrow"></span>Round Trip</h2><div class="tab-1 resp-tab-content roundtrip resp-tab-content-active" style="display:block" aria-labelledby="tab_item-0">
						<form action="" method="post">
							...
							<div class="date">
								<div class="depart">
									...
									<input class="form-control" name="start_date" type="date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
								</div>
								<div class="return">
									<h3 style="color: rgba(255, 255, 255, 0.767);">Return</h3>
									<input class="form-control" name="end_date" type="date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'mm/dd/yyyy';}" required="">
								</div>
								<div class="clear"></div>
							</div>
							<div class="class">
								...
								<div class="adults">
									...
									<div class="quantity"> 
										<div class="quantity-select">                           
											...
											<input type="hidden" name="pass_count" class="input_val" value="1">
					...
					<h2 class="resp-accordion" role="tab" aria-controls="tab_item-1"><span class="resp-arrow"></span>One way</h2><div class="tab-1 resp-tab-content oneway" aria-labelledby="tab_item-1">
						<form action="" method="POST">
							...
							<div class="to">
								<h3>To</h3>								
								<select value="0" name="arr_city" id="w3_country1">
								<option selected="" disabled="">Arrival</option><option value="San" jose="">San Jose</option><option value="Chicago">Chicago</option><option value="Olisphis">Olisphis</option><option value="Shiburn">Shiburn</option><option value="Weling">Weling</option><option value="Chiby">Chiby</option><option value="Odonhull">Odonhull</option><option value="Hegan">Hegan</option><option value="Oriaridge">Oriaridge</option><option value="Flerough">Flerough</option><option value="Yleigh">Yleigh</option><option value="Oyladnard">Oyladnard</option><option value="Trerdence">Trerdence</option><option value="Zhotrora">Zhotrora</option><option value="Otiginia">Otiginia</option><option value="Plueyby">Plueyby</option><option value="Vrexledo">Vrexledo</option><option value="Ariosey">Ariosey</option>								</select>									
							</div>
							<div class="clear"></div>
							<div class="date">
								<div class="depart">
...
<!-- <div class="conatiner-fluid p-4" style="background-color: whitesmoke;margin-top:150px;"> -->
	...
	<em><h5 class="text-light text-center p-0 brand mt-2">
				<img src="../images/airtic.png" height="40px" width="40px" alt="">				
			Online Flight Booking</h5></em>
	<div class="text-light text-center">© 2022 - Developed By Sujoy Dcunha, Christina Pereira, Mark Coutinho<br><br></div>
	<!-- <p>----------</p> -->
