					...
					<h2 class="resp-accordion resp-tab-active" role="tab" aria-controls="tab_item-0"><span class="resp-arrow"></span>Round Trip</h2><div class="tab-1 resp-tab-content roundtrip resp-tab-content-active" style="display:block" aria-labelledby="tab_item-0">
						<form action="book_flight.php" method="post">
							...
							<div class="from">
								...
								<option value="0" selected="" disabled="">Departure</option><option value="San" jose="">San Jose</option><option value="Chicago">Chicago</option><option value="Olisphis">Olisphis</option><option value="Shiburn">Shiburn</option><option value="Weling">Weling</option><option value="Chiby">Chiby</option><option value="Odonhull">Odonhull</option><option value="Hegan">Hegan</option><option value="Oriaridge">Oriaridge</option><option value="Flerough">Flerough</option><option value="Yleigh">Yleigh</option><option value="Oyladnard">Oyladnard</option><option value="Trerdence">Trerdence</option><option value="Zhotrora">Zhotrora</option><option value="Otiginia">Otiginia</option><option value="Plueyby">Plueyby</option><option value="Vrexledo">Vrexledo</option><option value="Ariosey">Ariosey</option>								</select>  
							</div>
							<div class="to">
					...
					<h2 class="resp-accordion" role="tab" aria-controls="tab_item-1"><span class="resp-arrow"></span>One way</h2><div class="tab-1 resp-tab-content oneway" aria-labelledby="tab_item-1">
						<form action="book_flight.php" method="post">
							...
							<div class="from">
								...
								<option selected="" disabled="">Departure</option><option value="San" jose="">San Jose</option><option value="Chicago">Chicago</option><option value="Olisphis">Olisphis</option><option value="Shiburn">Shiburn</option><option value="Weling">Weling</option><option value="Chiby">Chiby</option><option value="Odonhull">Odonhull</option><option value="Hegan">Hegan</option><option value="Oriaridge">Oriaridge</option><option value="Flerough">Flerough</option><option value="Yleigh">Yleigh</option><option value="Oyladnard">Oyladnard</option><option value="Trerdence">Trerdence</option><option value="Zhotrora">Zhotrora</option><option value="Otiginia">Otiginia</option><option value="Plueyby">Plueyby</option><option value="Vrexledo">Vrexledo</option><option value="Ariosey">Ariosey</option>								</select> 														
							</div>
							<div class="to">
								<h3>To</h3>								
								<select value="0" name="arr_city" id="w3_country1">
...
<div class="intro">
	...
	<div class="text-light text-center">© 2022 - Developed By Pradeep & Navdip, Surat<br><br></div>
