                        ...
                        <div class="row mb-5">                                                         
                           ...
                           <div class="col-8 out">
                               ...
                               <div class="row">
                                   <div class="col-3">
                                       <p class="head">departure</p>
                                       <p class="txt mb-1">2022-08-24</p>
                                       <p class="h1 font-weight-bold mb-3"> 22:32</p>  
                                   </div>            
                                   <div class="col-3">
                                       <p class="head">arrival</p>
                                       <p class="txt mb-1">2022-08-25</p>
                                       <p class="h1 font-weight-bold mb-3"> 23:34</p>  
                                   </div>
                                   <div class="col-3">
                                       <p class="head">gate</p>
                                       <p class="txt">A22</p>
